...
function newScils () {
	...
	if(scil !== '') {
		// то отобразить 
		document.getElementById('listScils').innerHTML += `<li class='liscil'>${scil}</li>`;
		// удалить содержимое
...
function Languages () {
	...
	if(newLanguages !== '') {
		document.getElementById('listLangulares').innerHTML += `<li class='listLangulares'>${newLanguages}</li>`;
